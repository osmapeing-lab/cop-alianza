...
const IconCerdo = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    <path d="M9.5,9A1.5,1.5 0 0,0 8,10.5A1.5,1.5 0 0,0 9.5,12A1.5,1.5 0 0,0 11,10.5A1.5,1.5 0 0,0 9.5,9M14.5,9A1.5,1.5 0 0,0 13,10.5A1.5,1.5 0 0,0 14.5,12A1.5,1.5 0 0,0 16,10.5A1.5,1.5 0 0,0 14.5,9M12,4L12.68,4.03C13.62,3.24 14.82,2.59 15.72,2.35C17.59,1.85 20.88,2.23 21,4.55C21.05,5.89 20,6.73 18.92,7.41C19.58,8.18 20,9.28 20,10.54C20,11.39 19.81,12.19 19.5,12.88C20.49,13.32 21.27,14.09 21.75,15.03C22.26,16.03 22.55,17.48 21.9,18.46C21.03,19.76 19.3,20.61 17.67,21.06C16.04,21.5 14.12,21.63 12,21.63C9.88,21.63 7.96,21.5 6.33,21.06C4.7,20.61 2.97,19.76 2.1,18.46C1.45,17.48 1.74,16.03 2.25,15.03C2.73,14.09 3.51,13.32 4.5,12.88C4.19,12.19 4,11.39 4,10.54C4,9.28 4.42,8.18 5.08,7.41C4,6.73 2.95,5.89 3,4.55C3.12,2.23 6.41,1.85 8.28,2.35C9.18,2.59 10.38,3.24 11.32,4.03L12,4M10.5,13.5C10.22,13.5 10,13.72 10,14V15C10,15.28 10.22,15.5 10.5,15.5H13.5C13.78,15.5 14,15.28 14,15V14C14,13.72 13.78,13.5 13.5,13.5H10.5Z"/>
  </svg>
)
